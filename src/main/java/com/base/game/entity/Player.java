...
public class Player extends Creature {
	...
	private Animation playerDown, playerLeft, playerUp, playerRight, playerDownLeft, playerDownRight, playerUpLeft,
			playerUpRight;

	private Animation playerDownMonkey, playerLeftMonkey, playerUpMonkey, playerRightMonkey, playerDownLeftMonkey,
			playerDownRightMonkey, playerUpLeftMonkey, playerUpRightMonkey;

	private Animation playerDownGunLance, playerLeftGunLance, playerRightGunLance, playerUpGunLance,
			playerDownLeftGunLance, playerDownRightGunLance, playerUpLeftGunLance, playerUpRightGunLance;
	...
	public void update() {
		...
		if (!(lastItemUsed instanceof GunLance || lastItemUsed instanceof Whip || state == "CLIMBINGUP"
				|| state == "CLIMBINGDOWN" || state == "CHEERING")) {
			yVar = 0;
			xVar = 0;
		}

		if (state == "CLIMBINGUP" || state == "CLIMBINGDOWN" || recovering || state == "DEAD" || state == "RISE"
				|| state == "CHEERING")
	...
	public void render(Graphics g) {
		super.render(g);
		if (bImage != null) {
			g.drawImage(bImage, (int) (x - handler.getCamera().getxOffset()),
					(int) (y - handler.getCamera().getyOffset()), width + xVar, height + yVar, null);
		} else {
			if (alpha != -1) {
				if (getCurrentAnimation() != null)
					Utils.drawFadedImage(g, alpha, currentAnimation.getCurrentFrame(),
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							width + xVar, height + yVar);
				else if (lastItemUsed instanceof MonkeyStaff)
					Utils.drawFadedImage(g, alpha, Assets.playerStationaryMonkey[direction],
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							width, height);
				else if (lastItemUsed instanceof GunLance)
					Utils.drawFadedImage(g, alpha, Assets.playerStationaryGunLance[direction],
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							70, 80);
				else
					Utils.drawFadedImage(g, alpha, Assets.playerStationary[direction],
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							width, height);
				...
				if (getCurrentAnimation() != null)
					...
					g.drawImage(Assets.playerStationaryMonkey[direction], (int) (x - handler.getCamera().getxOffset()),
							(int) (y - handler.getCamera().getyOffset()), width, height, null);
				else if (lastItemUsed instanceof GunLance)
					g.drawImage(Assets.playerStationaryGunLance[direction],
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							70, 80, null);
				else
					g.drawImage(Assets.playerStationary[direction], (int) (x - handler.getCamera().getxOffset()),
							(int) (y - handler.getCamera().getyOffset()), width, height, null);
			} else {
				if (getCurrentAnimation() != null)
					g.drawImage(Utils.tintImage(currentAnimation.getCurrentFrame(), rVal, gVal, bVal),
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							width + xVar, height + yVar, null);
				else if (lastItemUsed instanceof MonkeyStaff)
					g.drawImage(Utils.tintImage(Assets.playerStationaryMonkey[direction], rVal, gVal, bVal),
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							width, height, null);
				else if (lastItemUsed instanceof GunLance)
					g.drawImage(Utils.tintImage(Assets.playerStationaryGunLance[direction], rVal, gVal, bVal),
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							70, 80, null);
				else
					g.drawImage(Utils.tintImage(Assets.playerStationary[direction], rVal, gVal, bVal),
							(int) (x - handler.getCamera().getxOffset()), (int) (y - handler.getCamera().getyOffset()),
							width, height, null);
			}
		}
	...
	public void renderExpression(Graphics g) {
		if (expressionAnimation.isComplete())
			...
			g.drawImage(expressionAnimation.getCurrentFrame(),
					(int) (x + expressionOffsetX - handler.getCamera().getxOffset()),
					(int) (y + expressionOffsetY - handler.getCamera().getyOffset()),
					expressionAnimation.getCurrentFrame().getWidth() * 2,
					expressionAnimation.getCurrentFrame().getHeight() * 2, null);
	...
	public MainItem getItemD() {
		return itemD;
	}

	public void setItemW(MainItem itemW) {
		this.itemW = itemW;
	}
	...
	public void setItemD(MainItem itemD) {
		this.itemD = itemD;
	}

	public MainItem getLastItemUsed() {
		return lastItemUsed;
	}

	public void setLastItemUsed(MainItem lastItemUsed) {
	...
	public String getMoney() {
		return String.format("%03d", money);
	}
	...
	public void setCurrentAnimation(BufferedImage bufferedImage) {
		bImage = bufferedImage;
	}

	public long getLastTimeUsedItem() {
		return lastTimeUsedItem;
	}

	public void setLastTimeUsedItem(long lastTimeUsedItem) {
		this.lastTimeUsedItem = lastTimeUsedItem;
	}
