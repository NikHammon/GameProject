...
{	
	...
	public void action()
	{	
		if(distance == 0)// distance could refer to distance moved by an action. The thrust of the gauntlet in this case.
		{
		...
		if(e != null)
		{
			...
			{		
				...
				if(c.getHealth() > 0 && c.canBeKnkBack())
				{
					...
					c.setKnockBack((float)(bounds.x + bounds.width/2), (float)(bounds.y - bounds.height/2), knockBack);
				}
			}
		}
	}
