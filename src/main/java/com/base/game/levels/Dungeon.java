...
public enum Dungeon {
        ...
        Dungeon(int bossFloor, Point worldMapLocation, String theme, BufferedImage symbol, BufferedImage[] tileSet,
                        String[] enemies, String bossRoom) {
        ...
        public Point getWorldMapLocation() {
