...
import com.base.game.event.D8Event;
import com.base.game.tiles.CollisionMap;
import com.base.game.tiles.Tile;

public class Dgn8 extends Dungeon
{
	public Dgn8(Handler handler, LevelGenerator levelGenerator, ParallaxLayer pLayer, String name) 
	{
		super(handler, levelGenerator, pLayer, name);
		theme = "D1Theme";
		bossRoom = "D1Boss.txt";
		bossEvent = new D8Event(handler);
		bossFloorNum = 2;
		dgnNum = 8;
	}
	...
	{
		for(int i = 0; i < Assets.D8Tileset.length-4; i++)
		{
			tiles[i] = new Tile(Assets.D8Tileset[i], new CollisionMap(Integer.toString(i) + ".txt"), i);
		}
		...
		tiles[26] = new Tile(Assets.D8Tileset[20], new CollisionMap("11.txt"), 26);
		tiles[27] = new Tile(Assets.D8Tileset[21], new CollisionMap("11.txt"), 27);
		tiles[28] = new Tile(Assets.D8Tileset[22], new CollisionMap("11.txt"), 28);
		tiles[29] = new Tile(Assets.D8Tileset[23], new CollisionMap("7.txt"), 29);
