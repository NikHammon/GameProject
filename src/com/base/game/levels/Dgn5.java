...
import com.base.game.event.D5Event;
import com.base.game.tiles.CollisionMap;
import com.base.game.tiles.Tile;

public class Dgn5 extends Dungeon
{
	public Dgn5(Handler handler, LevelGenerator levelGenerator, ParallaxLayer pLayer, String name) 
	{
		super(handler, levelGenerator, pLayer, name);
		theme = "D1Theme";
		bossRoom = "D1Boss.txt";
		bossEvent = new D5Event(handler);
		bossFloorNum = 2;
		dgnNum = 5;
	}
	...
	{
		for(int i = 0; i < Assets.D5Tileset.length-4; i++)
		{
			tiles[i] = new Tile(Assets.D5Tileset[i], new CollisionMap(Integer.toString(i) + ".txt"), i);
		}
		...
		tiles[26] = new Tile(Assets.D5Tileset[20], new CollisionMap("11.txt"), 26);
		tiles[27] = new Tile(Assets.D5Tileset[21], new CollisionMap("11.txt"), 27);
		tiles[28] = new Tile(Assets.D5Tileset[22], new CollisionMap("11.txt"), 28);
		tiles[29] = new Tile(Assets.D5Tileset[23], new CollisionMap("7.txt"), 29);
