...
import com.base.game.event.D4Event;
import com.base.game.tiles.CollisionMap;
import com.base.game.tiles.Tile;

public class Dgn4 extends Dungeon
{
	public Dgn4(Handler handler, LevelGenerator levelGenerator, ParallaxLayer pLayer, String name) 
	{
		super(handler, levelGenerator, pLayer, name);
		theme = "D1Theme";
		bossRoom = "D1Boss.txt";
		bossEvent = new D4Event(handler);
		bossFloorNum = 2;
		dgnNum = 4;
	}
	...
	{
		for(int i = 0; i < Assets.D4Tileset.length-4; i++)
		{
			tiles[i] = new Tile(Assets.D4Tileset[i], new CollisionMap(Integer.toString(i) + ".txt"), i);
		}
		...
		tiles[26] = new Tile(Assets.D4Tileset[20], new CollisionMap("11.txt"), 26);
		tiles[27] = new Tile(Assets.D4Tileset[21], new CollisionMap("11.txt"), 27);
		tiles[28] = new Tile(Assets.D4Tileset[22], new CollisionMap("11.txt"), 28);
		tiles[29] = new Tile(Assets.D4Tileset[23], new CollisionMap("7.txt"), 29);
