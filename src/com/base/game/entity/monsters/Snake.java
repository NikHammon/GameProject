...
{
	public Snake(Handler handler, float x, float y, int layer, int level)
	{
		super(handler, x, y, layer, 120, 120, level);
		
		setBounds(new Rectangle(20, 28, 74, 60));
		baseSpeed = 3.5f;
		currSpeed = baseSpeed;
		...
		dwnLft = new Animation(125, Assets.snakeDwnLft, 0);
		dwnRgt = new Animation(125, Assets.snakeDwnRgt, 0);
		upLft = new Animation(125, Assets.snakeUpLft, 0);
		upRgt = new Animation(125, Assets.snakeUpRgt, 0);
		
		atkDwnLft = new Animation(100, Assets.snakeAtkDwnLft, 1);
		atkUpLft = new Animation(100, Assets.snakeAtkUpLft, 1);
		atkDwnRgt = new Animation(100, Assets.snakeAtkDwnRgt, 1);
		atkUpRgt = new Animation(100, Assets.snakeAtkUpRgt, 1);
